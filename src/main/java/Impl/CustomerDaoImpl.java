...
public class CustomerDaoImpl implements CustomerDao 
{
	...
	public boolean addCustomer(Customer c) 
	{
		try
		{
			...
			String sql= "insert into Customer_ctol18(custName,emailId,custPassword,custAddress,contactNo,custLocation) values(?,?,?,?,?,?)";
	...
	public boolean updateCustomer(Customer c1)
	{
		...
		String sql="update Customer_ctol18 set custName=?,custPassword=?,custAddress=?,contactNo=?,custLocation=? where emailId=?";
		PreparedStatement ps=con.prepareStatement(sql);
